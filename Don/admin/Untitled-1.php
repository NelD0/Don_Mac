...
// Replacing today's hourly sales with this month's daily sales
$monthSalesLabels = [];
$monthSalesData = [];
...
<div class="dashboard-container">
    ...
    <div class="chart-container">
        <div class="chart-box">
            <p class="chart-label">Total Users</p>
            <div class="chart-inner">
                <canvas id="usersChart"></canvas>
                <div class="chart-number"><?= $totalUsers; ?></div>
            </div>
        </div>
        <div class="chart-box">
...
createDoughnut('usersChart', <?= $totalUsers; ?>, '#261FB3');
